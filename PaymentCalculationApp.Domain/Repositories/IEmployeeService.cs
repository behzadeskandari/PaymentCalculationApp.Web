...
namespace PaymentCalculation.Domain.Repositories
{
    public interface IEmployeeService
    {
        ...
        Task UpdateEmployeeMonthAsync(DateTime month, EmployeeDto employeeDto);
        ...
        Task DeleteEmployeeAsync(EmployeeDetails employeeDelete, DateTime targetMonth);

        double CalculateSalaryEmployee(EmployeeCreate employeeCreate);
